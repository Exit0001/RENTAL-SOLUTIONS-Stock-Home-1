...
export async function uploadAttachment(file: File, folder: "maintenance" | "subrentals" | "incidents" | "stock-items" | "brands", companyId: string): Promise<string> {
...
interface FileUploadFieldProps {
  label: string;
  folder: "maintenance" | "subrentals" | "incidents" | "stock-items" | "brands";
  companyId: string;
  value: string | null;
