...
export async function uploadAttachment(file: File, folder: "maintenance" | "subrentals" | "incidents" | "stock-items" | "brands" | "avatars" | "job-expenses" | "sets" | "containers" | "crew" | "vehicles" | "jobs", companyId: string): Promise<string> {
...
interface FileUploadFieldProps {
  label: string;
  folder: "maintenance" | "subrentals" | "incidents" | "stock-items" | "brands" | "avatars" | "job-expenses" | "sets" | "containers" | "crew" | "vehicles" | "jobs";
  companyId: string;
  value: string | null;
