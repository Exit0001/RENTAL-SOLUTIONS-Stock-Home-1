...
export async function uploadAttachment(file: File, folder: "maintenance" | "subrentals" | "incidents" | "stock-items" | "brands" | "avatars", companyId: string): Promise<string> {
...
interface FileUploadFieldProps {
  label: string;
  folder: "maintenance" | "subrentals" | "incidents" | "stock-items" | "brands" | "avatars";
  companyId: string;
  value: string | null;
