      ...
      <div className="w-full max-w-md bg-surface-1 border border-fg/[0.08] rounded-2xl shadow-2xl animate-modal-up flex flex-col max-h-[90vh]">
        <div className="flex items-center justify-between px-5 py-4 border-b border-fg/[0.06] flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <h2 className="font-bold text-fg text-sm">เพิ่มรถเข้างาน</h2>
          </div>
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-3">
          <div>
            <label className="block text-[11px] font-bold text-fg/70 mb-1">รถ *</label>
          ...
          {vehicleId === "adhoc" && (
            <div>
              <label className="block text-[11px] font-bold text-fg/70 mb-1">ประเภทรถ</label>
          ...
          <div>
            <label className="block text-[11px] font-bold text-fg/70 mb-1">คนขับ (optional)</label>
