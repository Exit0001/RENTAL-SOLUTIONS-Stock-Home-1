      ...
      <div className="w-full max-w-md bg-surface-1 border border-fg/[0.08] rounded-2xl shadow-2xl animate-modal-up flex flex-col max-h-[80vh]">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-fg/[0.06] flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base font-bold text-fg">{t("manageContainerTypes.title")}</h2>
              <p className="text-[10px] text-fg/60">{t("manageContainerTypes.subtitle")}</p>
            </div>
          </div>
          <button
            onClick={onClose}
          ...
          {containerTypes.map((t: ContainerType) => (
            ...
            >
              <div className="flex items-center gap-2.5">
                <Layers className="w-3.5 h-3.5 text-fg/60 flex-shrink-0" />
                <span className="text-sm text-fg/70">{t.name}</span>
              </div>
              <button
