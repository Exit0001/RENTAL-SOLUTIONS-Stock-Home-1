      ...
      <div className="w-full max-w-lg bg-surface-1 border border-fg/[0.08] rounded-2xl shadow-2xl animate-modal-up max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between px-5 py-4 border-b border-fg/[0.06]">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-sm font-bold text-fg">{t("addIncident.title")}</h2>
              <p className="text-[10px] text-fg/50 truncate max-w-[280px]">{jobName}</p>
            </div>
          </div>
        ...
        <div className="p-5 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-[10px] text-fg/60 uppercase tracking-wider font-medium">{t("addIncident.descriptionLabel")}</label>
            <textarea
              value={description}
