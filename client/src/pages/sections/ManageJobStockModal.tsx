...
import { X, Package, Search, Loader2, Check, Save, ChevronDown, ChevronRight } from "lucide-react";
...
export const ManageJobStockModal = ({ jobId, jobName, onClose }: Props): JSX.Element => {
  ...
  useEffect(() => {
    ...
    // expand stock items ที่มี unit ถูก select อยู่
    if (ids.size > 0) {
              ...
              <div key={group.id} className="rounded-xl border border-white/[0.06] overflow-hidden">
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] text-white/30">{group.category} · {groupUnits.length} units</p>
                  </div>
